...
import garage.misc.tensor_utils as tu
...
class VPG(BatchPolopt):
    ...
    Args:
        ...
        optimization_epochs (int): Maximum number of epochs for update.
    ...
    def __init__(
        ...
        self._max_optimization_epochs = optimization_epochs
        self._eps = 1e-8
    ...
    def _train(self, obs, actions, rewards, advantages):
        ...
        Returns:
            torch.Tensor: Calculated mean scalar value of loss
